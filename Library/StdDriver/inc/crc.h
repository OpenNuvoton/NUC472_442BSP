 ...
 * $Revision: 2 $
 * $Date: 15/12/01 9:57a $
 * @brief    NUC472/NUC442 series CRC driver header file
 *
 * @note
...
/** @addtogroup NUC472_442_CRC_EXPORTED_CONSTANTS CRC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC472_442_CRC_EXPORTED_CONSTANTS */
